    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Deliberately NOT base_path(): this app stores decrypted
                // PSN/EA proof-of-activation screenshots under storage/app
                // and .env holds the encryption key + DB credentials in
                // plaintext — backing up the whole codebase (which is
                // already in version control) just to sweep .env into an
                // archive is unnecessary blast radius. Only what can't be
                // regenerated from git gets backed up here.
                'include' => [
                    storage_path('app'),
                ],
                ...
                'exclude' => [
                    ...
                    // Import files are deleted right after each import
                    // completes (see AccountImportService callers) — this
                    // directory is transient, never holds anything worth
                    // keeping between backups.
         ...
         */
        // A backup nobody can actually restore from is worse than no
        // backup — worth the extra time to confirm the archive opens.
        'verify_backup' => true,
